...
public class ChangeProfilePicture extends AppCompatActivity {
    ...
    private void startRegister(){
        ...
        if(!TextUtils.isEmpty(name) && !TextUtils.isEmpty(email) && !TextUtils.isEmpty(password)){
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        mProgress.dismiss();
                        Toast.makeText(ChangeProfilePicture.this, "Email already existed, please create another one", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(ChangeProfilePicture.this, "Fields are Empty", Toast.LENGTH_LONG).show();
        }
    }
